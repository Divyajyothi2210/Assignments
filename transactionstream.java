...
public class transactionstream {
	...
	public static void main(String[] args) {
		...
		Trader t1 = new Trader("divya","Delhi");
		Trader t2 = new Trader("goutham","Pune");
		Trader t3 = new Trader("rama","Indore");
		Trader t4 = new Trader("krishna","Pune");
		Trader t5 = new Trader("varalakshmi","Pune");
		Trader t6 = new Trader("jyothi","Indore");
		Trader t7 = new Trader("swaroop","Pune");
