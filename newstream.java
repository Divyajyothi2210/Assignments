...
public class newstream {
	...
	public static void main(String[] args) {
		...
		n.add(new News(1001, "divya","Comment:1","Budget is high"));
		n.add(new News(1002, "goutham","Comment:1","Budget is balanced"));
		n.add(new News(1001, "divya","Comment:2","Budget is low"));
		n.add(new News(1002, "goutham","Comment:2","Budget is high"));
		n.add(new News(1001, "divya","Comment:3","Budget is balanced"));
		n.add(new News(1003, "Rama","Comment:1","Budget is high"));
		n.add(new News(1003, "krishna","Comment:3","Budget is low"));
